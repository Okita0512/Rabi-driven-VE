...
data = np.loadtxt("./scaling short/1meV/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"$\lambda_F$ = 1 meV")

data = np.loadtxt("./scaling short/2meV/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"$\lambda_F$ = 2 meV")

data = np.loadtxt("./scaling short/4meV/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"$\lambda_F$ = 4 meV")

data = np.loadtxt("./scaling short/8meV/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"$\lambda_F$ = 8 meV")
...
y1, y2 = 0, 1.5e-11     # y-axis range: (y1, y2)
...
y_major_locator = MultipleLocator(5e-12)
y_minor_locator = MultipleLocator(1e-12)
...
data = np.loadtxt("./scaling short/1meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 1 meV")

data = np.loadtxt("./scaling short/2meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 2 meV")

data = np.loadtxt("./scaling short/4meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 4 meV")

data = np.loadtxt("./scaling short/8meV/Vib_pops_e.dat")
...
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 3e-8     # y-axis range: (y1, y2)
...
y_major_locator = MultipleLocator(1e-8)
y_minor_locator = MultipleLocator(2e-9)
...
if fit_results:
    print("FigS8 panel c fit results:")
...
if fit_results:
    print("FigS8 panel d fit results:")
    for entry in fit_results:
        print("  " + entry)
...
data = np.loadtxt("./scaling long (pump UP)/1meV/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 1 meV")

data = np.loadtxt("./scaling long (pump UP)/2meV/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 2 meV")

data = np.loadtxt("./scaling long (pump UP)/4meV/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 4 meV")

data = np.loadtxt("./scaling long (pump UP)/8meV/Vib_pops_g.dat")
...
time = 2000            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 6e-11     # y-axis range: (y1, y2)
...
data = np.loadtxt("./scaling long (pump UP)/1meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 1 meV")

data = np.loadtxt("./scaling long (pump UP)/2meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 2 meV")

data = np.loadtxt("./scaling long (pump UP)/4meV/Vib_pops_e.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$\lambda_F$ = 4 meV")

data = np.loadtxt("./scaling long (pump UP)/8meV/Vib_pops_e.dat")
...
time = 2000            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 3e-6     # y-axis range: (y1, y2)
...
if fit_results:
    print("FigS8 panel g fit results:")
    for entry in fit_results:
        print("  " + entry)
...
if fit_results:
    print("FigS8 panel h fit results:")
    for entry in fit_results:
        print("  " + entry)



plt.savefig("FigS8.pdf", bbox_inches='tight')

...
y1, y2 = 0, 2.5e-16     # y-axis range: (y1, y2)
...
plt.vlines(0.20, ymin = 0, ymax = 1.2e-15, colors = 'darkred', linestyles = 'dashed')
plt.text(0.204, 1e-15, r'$\Omega = \nu$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

plt.vlines(0.40, ymin = 0, ymax = 1.2e-15, colors = 'darkred', linestyles = 'dashed')
plt.text(0.304, 0.85e-15, r'$\Omega = 2\nu$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

# x and y range of plotting 
y1, y2 = 0.0, 1.2e-15     # y-axis range: (y1, y2)
...
y1, y2 = 0.0, 1.2e-17     # y-axis range: (y1, y2)
plt.ylim(y1, y2)

y_major_locator = MultipleLocator(5e-18)
y_minor_locator = MultipleLocator(1e-18)
ax2.yaxis.set_major_locator(y_major_locator)
ax2.yaxis.set_minor_locator(y_minor_locator)
...
y1, y2 = 0, 2e-23
y_major_locator = MultipleLocator(1e-23)
y_minor_locator = MultipleLocator(2e-24)
...
y1, y2 = 0.0, 1.2e-25     # y-axis range: (y1, y2)
plt.ylim(y1, y2)

y_major_locator = MultipleLocator(5e-26)
y_minor_locator = MultipleLocator(1e-26)
ax2.yaxis.set_major_locator(y_major_locator)
ax2.yaxis.set_minor_locator(y_minor_locator)
ax2.tick_params(which = 'major', length = 8, labelsize = 10, color = 'red')
ax2.tick_params(which = 'minor', length = 4, color = 'red')
...
plt.savefig("FigS10.pdf", bbox_inches='tight')

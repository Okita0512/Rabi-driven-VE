...
plt.plot(data[:,0], data[:,2], '-', label = "P_g_1 (0.16)")

data = np.loadtxt("./0.18/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = "P_g_1 (0.18)")

data = np.loadtxt("./0.20/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = "P_g_1 (0.20)")

data = np.loadtxt("./0.22/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = "P_g_1 (0.22)")

data = np.loadtxt("./0.24/Vib_pops_g.dat")

plt.plot(data[:,0], data[:,2], '-', label = "P_g_1 (0.24)")
...
time = 400            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 2e-8     # y-axis range: (y1, y2)

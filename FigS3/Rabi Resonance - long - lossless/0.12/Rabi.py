...
omega_v_eV  = 0.120       # vibrational frequency [eV] (used if vib_trunc>=2)
...
pulse_omega_eV  = 2.1        # pulse carrier [eV], # always pump the UP
...
def rhs(t, y):
    ...
    dalpha = -(kappa_rate/2 + 1j*Delta_c)*alpha - 1j * g * N * sigma_minus + eta + pulse_drive(t)

...
fig = plt.figure(figsize=(19, 10), dpi = 128)
...
y1, y2 = 0, 1.5e-4     # y-axis range: (y1, y2)
...
if fit_results:
    print("Fig4 panel b fit results:")
...
if fit_results:
    print("Fig4 panel e fit results:")
    for entry in fit_results:
        print("  " + entry)
...
if fit_results:
    print("Fig4 panel f fit results:")
    for entry in fit_results:
        print("  " + entry)

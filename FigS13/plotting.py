...
data = np.loadtxt("./Ultrashort Pulse/UP_LP_GS_DS_population.dat")

plt.plot(data[:,0], data[:,1], '-', linewidth = lw, color = 'tab:red', label = "UP")
plt.plot(data[:,0], data[:,2], '-', linewidth = lw, color = 'tab:blue', label = "LP")
plt.plot(data[:,0], data[:,3], '-', linewidth = lw, color = 'tab:green', label = "GS")
plt.plot(data[:,0], data[:,4], '-', linewidth = lw, color = 'tab:gray', label = "DS")
...
ax_inset.plot(data[:,0], data[:,1], '-', linewidth = lw, color = 'tab:red')
ax_inset.plot(data[:,0], data[:,2], '-', linewidth = lw, color = 'tab:blue')
ax_inset.plot(data[:,0], data[:,3], '-', linewidth = lw, color = 'tab:green')
ax_inset.plot(data[:,0], data[:,4], '-', linewidth = lw, color = 'tab:gray')
...
data = np.loadtxt("./Long Pulse 2.0eV/UP_LP_GS_DS_population.dat")
...
data = np.loadtxt("./Long Pulse 1.9eV/UP_LP_GS_DS_population.dat")
...
data = np.loadtxt("./Long Pulse 2.1eV/UP_LP_GS_DS_population.dat")

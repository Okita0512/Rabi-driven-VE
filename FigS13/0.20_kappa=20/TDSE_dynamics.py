...
if __name__ == "__main__":
    ...
    # Cavity loss: non-Hermitian H_eff = H - i*(kappa/2) * P_c ⊗ I_v
    kappa_ps = 20.0  # ps^-1 — cavity decay rate
    kappa_H = kappa_ps * FS_PER_AUT / 1000  # convert to Hartree (hbar = 1 a.u.)
    H = H - 1j * (kappa_H / 2) * kron(P_c, I_v, format='csr')

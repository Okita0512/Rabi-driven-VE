...
plt.plot(data[:,0], data[:,1], 'o-', label = "<Evib>")
...
ax.set_xlabel('N', font = 'Times New Roman', size = 20)
ax.set_ylabel(r'E (eV)', font = 'Times New Roman', size = 20)
...
plt.savefig("Evib.pdf", bbox_inches='tight')

...
data = np.loadtxt("./Ultrashort Pulse/exciton_photon_population.dat")

plt.plot(data[:,0], data[:,1], '-', linewidth = lw, color = 'tab:blue', label = "exciton")
plt.plot(data[:,0], data[:,2], '-', linewidth = lw, color = 'tab:red', label = "photon")
...
plt.plot(data[:,0], data[:,1], '-', linewidth = lw, color = 'tab:blue')
plt.plot(data[:,0], data[:,2], '-', linewidth = lw, color = 'tab:red')
...
data = np.loadtxt("./Long Pulse 2.0eV/exciton_photon_population.dat")
...
data = np.loadtxt("./Long Pulse 1.9eV/exciton_photon_population.dat")
...
data = np.loadtxt("./Long Pulse 2.1eV/exciton_photon_population.dat")

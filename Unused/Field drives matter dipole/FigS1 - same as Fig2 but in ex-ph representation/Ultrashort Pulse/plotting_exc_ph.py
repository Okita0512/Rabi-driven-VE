...
data = np.loadtxt("exciton_photon_population.dat")

plt.plot(data[:,0], data[:,1], '-', label = "exciton")
plt.plot(data[:,0], data[:,2], '-', label = "photon")
...
plt.savefig("Population_exc_ph.pdf", bbox_inches='tight')

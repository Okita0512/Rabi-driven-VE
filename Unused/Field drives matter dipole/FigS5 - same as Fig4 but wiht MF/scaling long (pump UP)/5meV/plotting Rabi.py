...
plt.plot(data[:,0], data[:,1] / 1e0, '-', label = "N_ph")
...
y1, y2 = 0.0, 1     # y-axis range: (y1, y2)

# plt.vlines(2 * np.pi / (0.2 / 0.658211951), 0, 1, color = 'green', linestyles = "--", linewidths = 2.0)
# plt.text(.2 * np.pi / (0.2 / 0.658211951), - 0.04, "harmonic period", color = 'green')
...
ax.set_xlabel('t (fs)', font = 'Times New Roman', size = 20)
ax.set_ylabel(r'Population', font = 'Times New Roman', size = 20)
ax.set_title('N = 64', font = 'Times New Roman', size = 20)

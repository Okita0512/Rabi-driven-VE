...
data = np.loadtxt("./0.20 - 1fs/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"1 fs")

data = np.loadtxt("./0.20 - 2fs/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"2 fs")

data = np.loadtxt("./0.20 - 5fs/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"5 fs")

data = np.loadtxt("./0.20 - 10fs/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"10 fs")

data = np.loadtxt("./0.20 - 20fs/Vib_pops_g.dat")

plt.plot(data[:,0] / 1000, data[:,2], '-', label = r"20 fs")
...
y1, y2 = 0, 3e-14      # y-axis range: (y1, y2)
...
plt.show()
# plt.savefig("FigSXXX.pdf", bbox_inches='tight')

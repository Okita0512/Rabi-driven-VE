...
if __name__ == "__main__":
    ...
    mu_op_plus_elec = csr_matrix(np.outer(e_b, e_g))
    mu_op_minus_elec = csr_matrix(np.outer(e_g, e_b))
    drive_op_plus = kron(mu_op_plus_elec, I_v, format='csr')
    drive_op_minus = kron(mu_op_minus_elec, I_v, format='csr')

...
data = np.loadtxt("./scaling long (pump UP)/N=1/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 1")

data = np.loadtxt("./scaling long (pump UP)/N=2/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 2")

data = np.loadtxt("./scaling long (pump UP)/N=4/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 4")

data = np.loadtxt("./scaling long (pump UP)/N=8/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 8")
...
y1, y2 = 0, 5e-9     # y-axis range: (y1, y2)
...
y_major_locator = MultipleLocator(1e-9)
y_minor_locator = MultipleLocator(2e-10)
...
y1, y2 = 0, 1e-21
y_major_locator = MultipleLocator(5e-22)
y_minor_locator = MultipleLocator(1e-22)
...
time = 2000            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 2e-2     # y-axis range: (y1, y2)
...
if fit_results:
    print("FigS7 panel c fit results:")
...
if fit_results:
    print("FigS7 panel d fit results:")
    for entry in fit_results:
        print("  " + entry)

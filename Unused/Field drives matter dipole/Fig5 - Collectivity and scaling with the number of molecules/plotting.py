...
data = np.loadtxt("./scaling short/N=1/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 1")

data = np.loadtxt("./scaling short/N=2/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 2")

data = np.loadtxt("./scaling short/N=4/Vib_level_pop.dat")

plt.plot(data[:,0], data[:,2], '-', label = r"$N$ = 4")

data = np.loadtxt("./scaling short/N=8/Vib_level_pop.dat")
...
y1, y2 = 0, 2.4e-13     # y-axis range: (y1, y2)
...
y_major_locator = MultipleLocator(1e-13)
y_minor_locator = MultipleLocator(2e-14)
...
plt.plot(data[:,0], 0 * 1e-5 + data[:,5], '-', label = r"$N$ = 1")

data = np.loadtxt("./scaling short/N=2/Vib_level_pop.dat")

plt.plot(data[:,0], 1 * 1e-5 + data[:,5], '-', label = r"$N$ = 2")

data = np.loadtxt("./scaling short/N=4/Vib_level_pop.dat")

plt.plot(data[:,0], 2 * 1e-5 + data[:,5], '-', label = r"$N$ = 4")

data = np.loadtxt("./scaling short/N=8/Vib_level_pop.dat")

plt.plot(data[:,0], 3 * 1e-5 + data[:,5], '-', label = r"$N$ = 8")
...
time = 2000            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 4.0e-5     # y-axis range: (y1, y2)

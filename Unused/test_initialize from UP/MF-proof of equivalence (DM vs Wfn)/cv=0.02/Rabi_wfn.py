...
# ---------------- save to disk ----------------
np.savetxt("Excited_population-wfn.dat", np.column_stack([sol.t, excited_pop]))
np.savetxt("Photon_number-wfn.dat",      np.column_stack([sol.t, photon_num]))
np.savetxt("Xg-wfn.dat",                 np.column_stack([sol.t, Xg_eV]))
np.savetxt("Vg-wfn.dat",                 np.column_stack([sol.t, Vg_eV]))

np.savetxt("Vib_pops_g-wfn.dat", np.column_stack([sol.t, vib_pops_g]))
np.savetxt("Vib_pops_e-wfn.dat", np.column_stack([sol.t, vib_pops_e]))

# (Optional) keep per-molecule file if you still want it
np.savetxt(
    "Evib_per_molecule-wfn.dat",

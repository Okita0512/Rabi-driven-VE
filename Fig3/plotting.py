...
y1, y2 = 0, 2.4e-6     # y-axis range: (y1, y2)
...
ax.legend(loc = 'upper left', frameon = False, fontsize = 11.2, ncol = 2)
...
plt.vlines(0.20, ymin = 0.5e-7, ymax = 1.2e-6, colors = 'darkred', linestyles = 'dashed')
plt.text(0.204, 1e-6, r'$\Omega = \nu$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

plt.vlines(0.40, ymin = 0.5e-7, ymax = 1.2e-6, colors = 'darkred', linestyles = 'dashed')
plt.text(0.304, 7e-7, r'$\Omega = 2\nu$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

# x and y range of plotting
y1, y2 = 0.0, 1.2e-6     # y-axis range: (y1, y2)
...
data = np.loadtxt("./Resonance-short-lossless/pe_n2_summary.csv", delimiter = ',', skiprows = 1)
...
time = 2000            # x-axis range: (0, time)
# y1, y2 = -0.2, 0.2     # y-axis range: (y1, y2)
y1, y2 = 0, 1.4e-3     # y-axis range: (y1, y2)
...
x_major_locator = MultipleLocator(500)
x_minor_locator = MultipleLocator(100)
y_major_locator = MultipleLocator(5e-4)
y_minor_locator = MultipleLocator(1e-4)
...
data = np.loadtxt("./Resonance-long-lossless/pe_n1_summary.csv", delimiter = ',', skiprows = 1)

plt.plot(data[:,0], data[:,1], '-o', label = r"$\langle P_{\mathrm{E}, \nu = 1} \rangle$", markersize = 8, color = 'navy')

plt.vlines(0.20, ymin = 0.5e-5, ymax = 6e-4, colors = 'darkred', linestyles = 'dashed')
plt.text(0.204, 5e-4, r'$\nu = \Omega$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

plt.vlines(0.10, ymin = 0.5e-5, ymax = 6e-4, colors = 'darkred', linestyles = 'dashed')
plt.text(0.104, 3e-4, r'$\nu = \frac{\Omega}{2}$', verticalalignment='center', fontsize = 20, fontname = 'Times New Roman', color = 'darkred')

# x and y range of plotting
y1, y2 = 0.0, 6e-4     # y-axis range: (y1, y2)
...
y_major_locator = MultipleLocator(2e-4)
y_minor_locator = MultipleLocator(1e-4)
...
# RHS y-axis
ax2 = ax.twinx()
data = np.loadtxt("./Resonance-long-lossless/pe_n2_summary.csv", delimiter = ',', skiprows = 1)
...
# Force a valid mathtext fontset in case external rc files override it.
plt.rcParams["mathtext.fontset"] = "stix"
plt.rcParams["mathtext.default"] = "regular"

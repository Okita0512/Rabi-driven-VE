...
plt.plot(data1[:,0], 10000 * data1[:,1], '-', linewidth = lw, color = 'tab:blue', label = "Exciton")
...
ax_inset.plot(data1[:,0], 10000 * data1[:,1], '-', linewidth = lw, color = 'tab:blue')
...
plt.plot(data[:,0], 10000 * data[:,1], '-', linewidth = lw, color = 'tab:blue', label = "Exciton")
